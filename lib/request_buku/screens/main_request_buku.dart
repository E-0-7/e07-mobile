...
class MainRequestBuku extends StatefulWidget {
  ...
  @override
  State<MainRequestBuku> createState() => _MainRequestBukuState();
}
...
class _MainRequestBukuState extends State<MainRequestBuku> {
  ...
  void deleteRequestStatusBuku(request, id) async {
    try {
      ...
      var response = await request.post(
          "https://flex-lib.domcloud.dev/request_buku/delete_request_buku_flutter/$id",
          {});
  ...
  Future<List<RequestStatusBuku>> fetchRequestStatusBuku(request) async {
    List<RequestStatusBuku> listRequestStatusBuku = [];
    ...
    var response = await request
        .get("https://flex-lib.domcloud.dev/request_buku/get_item/");
    for (var d in response) {
      if (d != null) {
        listRequestStatusBuku.add(RequestStatusBuku.fromJson(d));
      }
    }
    return listRequestStatusBuku;
  }
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon:
                  const Icon(Icons.account_circle), // This is the profile icon
              onPressed: () {
              ...
              Positioned.fill(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(
                        0xFF0B1F49), // This is your background color
