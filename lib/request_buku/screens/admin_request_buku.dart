...
class AdminPageRequest extends StatefulWidget {
  ...
  const AdminPageRequest({Key? key, required this.requestStatusBuku})
      : super(key: key);

  @override
  State<AdminPageRequest> createState() => _AdminPageState();
}

class _AdminPageState extends State<AdminPageRequest> {
  final _formKey = GlobalKey<FormState>();
  String status = "";
  final List<String> statusBuku = ["PENDING", "DITERIMA", "DITOLAK"];
        ...
        body: Form(
          ...
          child: SingleChildScrollView(
            ...
            children: [
              ...
              Text(
                  "Tahun Publikasi : ${widget.requestStatusBuku.tahunPublikasi}"),
              Text(
                  "Tanggal Request : ${widget.requestStatusBuku.tanggalRequest}"),
              Row(children: [
                const Text("Status Buku : "),
                DropdownButton<String>(
                  value: dropdownValue,
                  style: ThemeApp.lightTextTheme.bodyMedium,
                  items:
                      statusBuku.map<DropdownMenuItem<String>>((String value) {
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          final response = await request.post(
                              "https://flex-lib.domcloud.dev/request_buku/change_status/",
                              jsonEncode(<String, String>{
                                "id_buku":
                                    widget.requestStatusBuku.id.toString(),
