...
class DetailRequestBuku extends StatelessWidget {
  ...
  DetailRequestBuku({required this.statusRequestBuku});
              ...
              children: [
                ...
                Center(
                  ...
                  Column(
                    ...
                    children: [
                      Text("Judul Buku : ${statusRequestBuku.judulBuku}", style: ThemeApp.lightTextTheme.titleLarge),
                      Text("Author : ${statusRequestBuku.author}", style: ThemeApp.lightTextTheme.displaySmall,),
